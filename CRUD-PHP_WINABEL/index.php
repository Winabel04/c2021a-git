        ...
        <table class="table table-striped table-hover">
          ...
          ?>
            <tr>
              ...
              <td><?php echo $row['list-to-do']?></td>
              <td><a type = "submit" name = "edit" href = "index.php?id_edit=<?php echo $row['id'] ?>" data-toggle="modal" data-target="#updateModal"><i class='fa fa-edit' style='font-size:16px;color:blue'></i></a></td>
              <td><a type = "submit" name = "delete" href = "index.php?id_delete=<?php echo $row['id'] ?>"data-toggle="modal" data-target="#updateModal"><i class='fa fa-trash-o' data-toggle="modal" data-target="#deleteModal" style='font-size:16px;color:red'></i></a></td>
            </tr>
                 <!-- Edit Modal HTML -->
                ...
                <form>
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $row['list-to-do'] ?>">
                    </div>
                  </div>
